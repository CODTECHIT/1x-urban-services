          ...
          <div className="mb-20">
            {(() => {
              const customImages: { [key: string]: string } = {
                "kitchen-cleaning":
                  "/images/services/sub/kitchen-cleaning-v2.jpg",
                "cockroach-ant-control":
                  "/images/services/sub/cockroach-ant-control-v2.png",
                "termite-control":
                  "/images/services/sub/termite-control-v2.jpg",
                "office-relocation":
                  "/images/services/sub/office-relocation.jpg",
                "home-shifting": "/images/services/sub/home-shifting-v2.png",
                "electrical-services":
                  "/images/services/sub/electrical-services-v2.jpg",
                "balcony-cleaning":
                  "/images/services/sub/balcony-cleaning-v2.jpg",
                "window-cleaning":
                  "/images/services/sub/window-cleaning-v2.jpg",
                "sofa-cleaning": "/images/services/sub/sofa-cleaning-v2.jpg",
                "water-tank-cleaning":
                  "/images/services/sub/water-tank-cleaning-v2.jpg",
                "interior-painting":
                  "/images/services/sub/interior-painting-v2.png",
              };
            ...
            <Reveal direction="up" delay={0.2} width="100%">
              <div>
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h2 className="text-3xl md:text-4xl font-black text-slate-700">
                    Key Benefits
                  </h2>
                </div>
          ...
          <Reveal direction="up" delay={0.1} width="100%">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-black mb-4">
                Why Choose 1X Urban Services?
              </h2>
              <p className="text-lg text-slate-600 max-w-2xl mx-auto">
                We are committed to delivering the highest quality service with
              ...
              .map((relatedService, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-xs text-slate-500 font-bold mb-3 line-clamp-2">
